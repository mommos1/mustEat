        ...
        <section class="py-5">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <form method="post">
                        <input class="form-control" name="name" type="text" value="${jokbal_view.name}" placeholder="맛집명을 입력해주세요" />
                                    <p class="help-block"></p>
                        <p>
                            <input class="form-control" name="phone" type="tel" value="${jokbal_view.phone}" placeholder="연락처를 입력 해주세요." />
                        </p>
                        <p>
                            <input class="form-control" name="address" type="address" value="${jokbal_view.address}" placeholder="주소를 입력 해주세요." />                            
                        </p>
                        <p>
							<textarea class="form-control" name="message" rows="10" cols="100" placeholder="맛집에 대해 설명해주세요." maxlength="999" style="resize: none">${jokbal_view.message}</textarea>
                        </p>
                        <button class="btn btn-primary" id="sendMessageButton" type="submit" >수정하기</button>
                        </form>
                    </div>
                </div>                                                       
        </section>
